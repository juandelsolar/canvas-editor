...
function environments(exprs) {
  ...
  while (i < exprs.length) {
    if (exprs[i].text == "\\begin") {
      ...
      const es2 = exprs.splice(i + 1, j - (i + 1));
      environments(es2);
...
class Previewer {
  ...
  _updateResizerRect(width, height) {
    ...
    for (let i = 0; i < 8; i++) {
      const left = i === 0 || i === 6 || i === 7 ? -handleSize : i === 1 || i === 5 ? width / 2 : width - handleSize;
...
const contextmenu = {
  ...
  hyperlink: {
    "delete": "Eliminar hiperv\xEDnculo",
    cancel: "Cancelar hiperv\xEDnculo",
    edit: "Editar hiperv\xEDnculo"
  },
  image: {
  ...
  table: {
    insertRowCol: "Insertar fila columna",
    insertTopRow: "Insertar arriba 1 fila",
    insertBottomRow: "Insertar abajo 1 fila",
    insertLeftCol: "Insertar izquierda 1 columna",
    insertRightCol: "Insertar derecha 1 columna",
    deleteRowCol: "Eliminar fila columna",
    deleteRow: "Eliminar 1 fila",
    deleteCol: "Eliminar 1 columna",
    deleteTable: "Eliminar table",
    mergeCell: "Unir celda",
    mergeCancelCell: "Cancelar uni\xF3n celda",
    verticalAlign: "Aliniar verticalmente",
    verticalAlignTop: "Arriba",
    verticalAlignMiddle: "Medio",
    verticalAlignBottom: "Abajo",
    border: "Borde de tabla",
    borderAll: "Todo",
    borderEmpty: "Vac\xEDo",
    borderExternal: "Externo",
    borderTd: "Borde de celda",
    borderTdBottom: "Abajo",
    borderTdForward: "adelante",
    borderTdBack: "atr\xE1s"
  }
};
const datePicker = {
  now: "Ahora",
...
const pageBreak = {
  displayName: "Salto de P\xE1gina"
};
const zone = {
  headerTip: "Doble click para editar el encabezado",
  footerTip: "Doble click para editar el pie de p\xE1gina"
};
var es = {
  contextmenu,
  datePicker,
...
class ZoneTip {
  ...
  _updateZoneTip(visible, left, top) {
    if (visible) {
